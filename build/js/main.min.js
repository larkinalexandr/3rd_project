...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function setupVideo(video) {
    var button = video.querySelector('.video__link-button');
    var href = button.href;

    var startVideo = function startVideo(evt) {
  ...
  var tabsTitleList = document.querySelector('.tabs__title-list');
  var tabTitle = tabsTitleList.querySelectorAll('li');
  var tabsContent = document.querySelector('.tabs__content');
  var tabsContentList = tabsContent.querySelectorAll('ul');

  if (tabsTitleList && tabsContent && tabTitle.length > 0 && tabsContentList.length > 0) {
    (function () {
      var setActiveTab = function setActiveTab(index) {
  ...
  var trainerCard = document.querySelectorAll('.trainer-card');

  var showTrainerInfo = function showTrainerInfo(element, className) {
    trainerCard.forEach(function (el) {
      return el.classList.remove('is-show');
    });
    element.classList.add(className);
  };

  var setTrainerInfo = function setTrainerInfo(element) {
  ...
  if (trainerCard.length > 0) {
    trainerCard.forEach(function (element) {
